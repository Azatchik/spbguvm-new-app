...
import cls from './FooterContactsSmallScreen.module.scss';

interface FooterContactsSmallScreenProps {
    className?: string;
}

export const FooterContactsSmallScreen = memo((props: FooterContactsSmallScreenProps) => {
    const { className } = props;
    const { t } = useTranslation();

    return (
        <VStack
            className={classNames(cls.FooterContactsSmallScreen, {}, [className])}
            gap="40"
        >
            <Text
