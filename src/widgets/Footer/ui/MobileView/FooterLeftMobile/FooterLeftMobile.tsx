...
import cls from './FooterLeftMobile.module.scss';

interface FooterLeftMobileProps {
    className?: string;
}

export const FooterLeftMobile = memo((props: FooterLeftMobileProps) => {
    const { className } = props;
    const { t } = useTranslation();

    return (
        <VStack
            className={classNames(cls.FooterLeftMobile, {}, [className])}
            justify="between"
        >
            <Icon
