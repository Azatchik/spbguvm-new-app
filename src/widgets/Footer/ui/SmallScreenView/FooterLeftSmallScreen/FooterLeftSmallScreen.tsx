...
import cls from './FooterLeftSmallScreen.module.scss';

interface FooterLeftSmallScreenProps {
    className?: string;
}

export const FooterLeftSmallScreen = memo((props: FooterLeftSmallScreenProps) => {
    const { className } = props;
    const { t } = useTranslation();

    return (
        <VStack
            className={classNames(cls.FooterLeftSmallScreen, {}, [className])}
            justify="between"
        >
            <Icon
