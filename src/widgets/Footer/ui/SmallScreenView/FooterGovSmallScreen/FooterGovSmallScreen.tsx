...
import cls from './FooterGovSmallScreen.module.scss';

interface FooterGovSmallScreenProps {
    className?: string;
}

export const FooterGovSmallScreen = memo((props: FooterGovSmallScreenProps) => {
    const { className } = props;
    const { t } = useTranslation();

    return (
        <VStack
            className={classNames(cls.FooterGovSmallScreen, {}, [className])}
            gap="20"
            justify="end"
        >
            <VStack
